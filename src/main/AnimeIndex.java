...
import util.task.NewSuggestionsNotifierTask;
...
public class AnimeIndex extends JFrame
{
	...
	public AnimeIndex()
	{
		...
		setBounds((int) Toolkit.getDefaultToolkit().getScreenSize().getWidth() /5, ((int)Toolkit.getDefaultToolkit().getScreenSize().getHeight() /7)-20, 800, 520);
