	...
	protected void done()
	{
		for (String anime : conflictedAnime)
		{
			...
			if (map.size() > 1)
			{
				...
				String animeName = (String) JOptionPane.showInputDialog(AnimeIndex.frame, "Scegli l'anime da aggiungere", "Conflitto trovato", JOptionPane.QUESTION_MESSAGE, null, animeArray, animeArray[0]);
				if (animeName != null)
				{
					int id = map.get(animeName);
					String episode = "";
