		...
		if (AnimeIndex.filtro != 9)
		{
			...
			for (int i = 0; i < modelArray.length; i++)
			{
				...
				else
				{
					...
					// else
					// {
					// if(!data.getReleaseDate().equalsIgnoreCase("??/??/????")
					// && !data.getReleaseDate().substring(0,
					// 6).equalsIgnoreCase("??/??/") &&
					// !data.getReleaseDate().substring(0,
					// 3).equalsIgnoreCase("??/") &&
					// (data.getCurrentEpisode().equalsIgnoreCase("??") ||
					// data.getCurrentEpisode().equalsIgnoreCase("0") ||
					// data.getCurrentEpisode().equalsIgnoreCase("1")))
					// {
					// int currentDay = calendar.get(Calendar.DATE);
					// int currentMonth = calendar.get(Calendar.MONTH)+1;
					// int currentYear = calendar.get(Calendar.YEAR);
					// String currentData = currentDay + "/" + currentMonth +
					// "/" + currentYear;
					...
					// }
					// else if
					// (!data.getFinishDate().equalsIgnoreCase("??/??/????") &&
					// !data.getFinishDate().substring(0,
					// 6).equalsIgnoreCase("??/??/") &&
					// !data.getFinishDate().substring(0,
					// 3).equalsIgnoreCase("??/"))
					// {
