...
public class PreferenceDialogBKP extends JDialog
{
	...
	public PreferenceDialogBKP()
	{
			...
			btnEsporta.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e)
				{
					...
					if (fileList.length == 0)
						JOptionPane.showMessageDialog(PreferenceDialogBKP.this, "Nessun file di log esistente", "Errore", JOptionPane.WARNING_MESSAGE);
					else
					{
						Object file = JOptionPane.showInputDialog(PreferenceDialogBKP.this, "Quale file vuoi esportare?", "Esportazione", JOptionPane.QUESTION_MESSAGE, null, fileList, fileList[0]);
		...
		}
		{
			...
			btnCancella.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e)
				{
					int choiche = JOptionPane.showConfirmDialog(PreferenceDialogBKP.this, "Vuoi rimuovere tutti i file di log?", "Attenzione!", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
			...
			exportButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (returnVal == JFileChooser.APPROVE_OPTION)
					{
						...
						WaitDialog waitForZip = new WaitDialog("Esportando...", "Esportando i dati", task, PreferenceDialogBKP.this);
						waitForZip.setLocationRelativeTo(PreferenceDialogBKP.this);
			...
			importButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (returnVal == JFileChooser.APPROVE_OPTION)
					{
						...
						WaitDialog waitForZip = new WaitDialog("Importando...", "Importando i dati", task, PreferenceDialogBKP.this);
						waitForZip.setLocationRelativeTo(PreferenceDialogBKP.this);
						waitForZip.setVisible(true);
					}
				}
